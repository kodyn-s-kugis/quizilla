...
async function askQuestion(interaction, theme, difficulty) {
    ...
    return new Promise(async (resolve, reject) => {
        ...
        /*
        ************************************************************************************************************
        The game object will have the following structure:
        const game = {
           channels: {},
           players: [],
        };
        With data:
         [
             ...
             { id: '97272043866689536', points: 0 }
         ]
        Can be accessed like: game.players[index].points
        and points written like:
        playerIndex = game.player.findIndex(player => player.id === interaction.user.id)
        game.players[playerIndex].points += <amount>
        ************************************************************************************************************
        */
